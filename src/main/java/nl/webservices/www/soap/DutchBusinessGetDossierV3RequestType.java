/**
 * DutchBusinessGetDossierV3RequestType.java
 *
...
public class DutchBusinessGetDossierV3RequestType  implements java.io.Serializable {
    private java.lang.String dossier_number;

    private java.lang.String establishment_number;

    public DutchBusinessGetDossierV3RequestType() {
    }
    ...
    /**
     * Gets the dossier_number value for this DutchBusinessGetDossierV3RequestType.
     * 
    ...
    /**
     * Sets the dossier_number value for this DutchBusinessGetDossierV3RequestType.
     * 
    ...
    /**
     * Gets the establishment_number value for this DutchBusinessGetDossierV3RequestType.
     * 
    ...
    /**
     * Sets the establishment_number value for this DutchBusinessGetDossierV3RequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DutchBusinessGetDossierV3RequestType)) return false;
        DutchBusinessGetDossierV3RequestType other = (DutchBusinessGetDossierV3RequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DutchBusinessGetDossierV3RequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "dutchBusinessGetDossierV3RequestType"));
