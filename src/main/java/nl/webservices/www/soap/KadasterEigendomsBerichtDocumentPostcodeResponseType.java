/**
 * KadasterEigendomsBerichtDocumentPostcodeResponseType.java
 *
...
public class KadasterEigendomsBerichtDocumentPostcodeResponseType  implements java.io.Serializable {
    private nl.webservices.www.soap.BerichtObjectDocumentResultaat berichtobjectresultaat;

    public KadasterEigendomsBerichtDocumentPostcodeResponseType() {
    }
    ...
    /**
     * Gets the berichtobjectresultaat value for this KadasterEigendomsBerichtDocumentPostcodeResponseType.
     * 
    ...
    /**
     * Sets the berichtobjectresultaat value for this KadasterEigendomsBerichtDocumentPostcodeResponseType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof KadasterEigendomsBerichtDocumentPostcodeResponseType)) return false;
        KadasterEigendomsBerichtDocumentPostcodeResponseType other = (KadasterEigendomsBerichtDocumentPostcodeResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(KadasterEigendomsBerichtDocumentPostcodeResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "kadasterEigendomsBerichtDocumentPostcodeResponseType"));
