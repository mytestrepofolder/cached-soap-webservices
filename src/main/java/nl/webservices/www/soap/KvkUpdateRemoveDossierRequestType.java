/**
 * KvkUpdateRemoveDossierRequestType.java
 *
...
public class KvkUpdateRemoveDossierRequestType  implements java.io.Serializable {
    private java.lang.String dossier_number;

    private java.lang.String establishment_number;

    public KvkUpdateRemoveDossierRequestType() {
    }
    ...
    /**
     * Gets the dossier_number value for this KvkUpdateRemoveDossierRequestType.
     * 
    ...
    /**
     * Sets the dossier_number value for this KvkUpdateRemoveDossierRequestType.
     * 
    ...
    /**
     * Gets the establishment_number value for this KvkUpdateRemoveDossierRequestType.
     * 
    ...
    /**
     * Sets the establishment_number value for this KvkUpdateRemoveDossierRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof KvkUpdateRemoveDossierRequestType)) return false;
        KvkUpdateRemoveDossierRequestType other = (KvkUpdateRemoveDossierRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(KvkUpdateRemoveDossierRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "kvkUpdateRemoveDossierRequestType"));
