...
public class CarDataV3Result  implements java.io.Serializable {
    private nl.webservices.www.soap.CarV3 car_data;

    private nl.webservices.www.soap.CarType[] types;

    public CarDataV3Result() {
    }

    public CarDataV3Result(
           nl.webservices.www.soap.CarV3 car_data,
    ...
    /**
     * Gets the car_data value for this CarDataV3Result.
     * 
     * @return car_data
     */
    public nl.webservices.www.soap.CarV3 getCar_data() {
        return car_data;
    }


    /**
     * Sets the car_data value for this CarDataV3Result.
     * 
     * @param car_data
     */
    public void setCar_data(nl.webservices.www.soap.CarV3 car_data) {
        this.car_data = car_data;
    }


    /**
     * Gets the types value for this CarDataV3Result.
     * 
     * @return types
     */
    ...
    /**
     * Sets the types value for this CarDataV3Result.
     * 
     * @param types
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CarDataV3Result)) return false;
        CarDataV3Result other = (CarDataV3Result) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CarDataV3Result.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "CarDataV3Result"));
