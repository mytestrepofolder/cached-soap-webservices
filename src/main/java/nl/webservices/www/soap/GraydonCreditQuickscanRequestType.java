/**
 * GraydonCreditQuickscanRequestType.java
 *
...
public class GraydonCreditQuickscanRequestType  implements java.io.Serializable {
    private java.math.BigInteger graydon_company_id;

    public GraydonCreditQuickscanRequestType() {
    }
    ...
    /**
     * Gets the graydon_company_id value for this GraydonCreditQuickscanRequestType.
     * 
    ...
    /**
     * Sets the graydon_company_id value for this GraydonCreditQuickscanRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GraydonCreditQuickscanRequestType)) return false;
        GraydonCreditQuickscanRequestType other = (GraydonCreditQuickscanRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GraydonCreditQuickscanRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "graydonCreditQuickscanRequestType"));
