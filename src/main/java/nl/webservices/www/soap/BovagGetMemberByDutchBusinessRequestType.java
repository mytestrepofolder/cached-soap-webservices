/**
 * BovagGetMemberByDutchBusinessRequestType.java
 *
...
public class BovagGetMemberByDutchBusinessRequestType  implements java.io.Serializable {
    private java.lang.String dossier_number;

    private java.lang.String establishment_number;

    public BovagGetMemberByDutchBusinessRequestType() {
    }
    ...
    /**
     * Gets the dossier_number value for this BovagGetMemberByDutchBusinessRequestType.
     * 
    ...
    /**
     * Sets the dossier_number value for this BovagGetMemberByDutchBusinessRequestType.
     * 
    ...
    /**
     * Gets the establishment_number value for this BovagGetMemberByDutchBusinessRequestType.
     * 
    ...
    /**
     * Sets the establishment_number value for this BovagGetMemberByDutchBusinessRequestType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BovagGetMemberByDutchBusinessRequestType)) return false;
        BovagGetMemberByDutchBusinessRequestType other = (BovagGetMemberByDutchBusinessRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BovagGetMemberByDutchBusinessRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "bovagGetMemberByDutchBusinessRequestType"));
