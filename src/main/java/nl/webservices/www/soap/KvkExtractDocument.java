...
public class KvkExtractDocument  implements java.io.Serializable {
    private byte[] document;

    private java.util.Calendar document_date;

    public KvkExtractDocument() {
    }
    ...
    /**
     * Gets the document value for this KvkExtractDocument.
     * 
     * @return document
     */
    ...
    /**
     * Sets the document value for this KvkExtractDocument.
     * 
     * @param document
     */
    ...
    /**
     * Gets the document_date value for this KvkExtractDocument.
     * 
    ...
    /**
     * Sets the document_date value for this KvkExtractDocument.
     * 
     * @param document_date
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof KvkExtractDocument)) return false;
        KvkExtractDocument other = (KvkExtractDocument) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(KvkExtractDocument.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "KvkExtractDocument"));
