/**
 * KvkGetExtractDocumentRequestType.java
 *
...
public class KvkGetExtractDocumentRequestType  implements java.io.Serializable {
    private java.lang.String dossier_number;

    private boolean allow_caching;

    public KvkGetExtractDocumentRequestType() {
    }
    ...
    /**
     * Gets the dossier_number value for this KvkGetExtractDocumentRequestType.
     * 
    ...
    /**
     * Sets the dossier_number value for this KvkGetExtractDocumentRequestType.
     * 
    ...
    /**
     * Gets the allow_caching value for this KvkGetExtractDocumentRequestType.
     * 
    ...
    /**
     * Sets the allow_caching value for this KvkGetExtractDocumentRequestType.
     * 
     * @param allow_caching
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof KvkGetExtractDocumentRequestType)) return false;
        KvkGetExtractDocumentRequestType other = (KvkGetExtractDocumentRequestType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(KvkGetExtractDocumentRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.webservices.nl/soap/", "kvkGetExtractDocumentRequestType"));
